...
function Header() {
  ...
  return (
    <header>
      <div className="p-5 flex items-center justify-between bg-[#B5BDE1]">
        ...
        <div className="flex items-center gap-4">
          <h1 className="text-white hover:text-blue-500 text-2xl">
      ...
      >
        ...
        <ul className="text-center py-5">
          ...
          <li className="text-white hover:text-violet-900 poppins-light poppins-semibold pb-3">
